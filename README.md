...
This is a handcrafted, bare-metal x86 operating system kernel built from scratch. It's a passion project designed to explore low-level hardware interactions, memory management, and crafting a custom shell environment—no fancy modern OS bloat, just you, the CPU, and the hardware.
...
- `kernel_qemu/` - This is where the main stuff happen! It contains the bare-metal hardware drivers (VGA, Keyboard, Serial), the bootloader, memory segmentation, and the actual kernel entry-point.
...
I hope you have as much fun exploring it as I did building it! If you find any cool quirks or want to add a new command, feel free to start a pull request into the code.
